@can('edit-pengiriman')
    <div x-data="{ resi: @entangle('no_resi') }" class="p-4 bg-gray-100 dark:bg-gray-600 flex w-full h-screen flex-col">
        <div
            ...
            <div class="py-2">
                <h1 class="text-2xl font-bold text-gray-900 dark:text-white">Edit Pengiriman Resi#<span x-text="resi"></span>
                </h1>
                <p class="text-sm font-medium text-gray-500 dark:text-gray-300">Form Edit Pengiriman ABCD Ekspedisi</p>
            </div>
        </div>
            ...
            <div class="flex py-2 w-full bg-gray-100 dark:bg-slate-700 mx-auto flex-col items-center rounded-xl">
                <div class="flex flex-col w-full md:px-6">
                    ...
                    <form wire:submit="tambahPengiriman" class="flex flex-col space-y-5" action="">
                        ...
                        <button type="button" x-on:click="$dispatch('edit-pengiriman-show')"
                            class="w-full md:w-80 mx-auto mt-2 self-center text-black hover:text-gray-700 bg-yellow-300 dark:bg-blue-500 dark:hover:bg-blue-700 hover:bg-yellow-200 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:text-white">Edit
                            Pengiriman</button>
                    </form>
                </div>
            </div>
        ...
        <x-modals.edit-modal>
            <x-slot name="tanya">
                <div>
                    <h3 class="mb-4 text-base sm:text-lg font-normal text-gray-800">Edit Pengiriman
                        Resi <span x-text="resi"></span>?</h3>
                </div>
            </x-slot>
            <x-slot name="setuju">
                <button wire:click="editPengiriman" data-modal-hide="popup-modal" type="button"
            ...
            <x-slot name="cancel">
                <button x-on:click="$dispatch('close-modal-edit')" data-modal-hide="popup-modal" type="button"
